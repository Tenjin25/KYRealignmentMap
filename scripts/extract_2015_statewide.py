"""
Extract ALL 2015 Kentucky statewide races.
...
# Define all 2015 races with their candidates
RACES_2015 = [
    {
        'office': 'Governor',
        'page_start': 1,
        'candidates': [
            {'name': 'Matt Bevin', 'party': 'REP'},
            {'name': 'Jack Conway', 'party': 'DEM'},
            {'name': 'Drew Curtis', 'party': 'IND'},
            {'name': 'Blackii Effing Whyte', 'party': 'IND'},
            {'name': 'Gatewood B. Gatewood', 'party': 'WI'}
        ]
    },
    {
        ...
        'candidates': [
            ...
            {'name': 'Stephen L. Knipper', 'party': 'REP'}
        ]
    },
    {
        ...
        'candidates': [
            ...
            {'name': 'Whitney H. Westerfield', 'party': 'REP'}
        ]
    },
    {
        ...
        'page_start': 17,
        'candidates': [
            {'name': 'Mike Harmon', 'party': 'REP'},
            {'name': 'Adam H. Edelen', 'party': 'DEM'}
        ]
    },
    {
    ...
    },
    {
        ...
        'page_start': 27,
        'candidates': [
            {'name': 'Ryan F. Quarles', 'party': 'REP'},
            {'name': 'Jean-Marie Lawson Spann', 'party': 'DEM'}
        ]
    }
]
...
def extract_race(pdf, race_info):
    ...
    # Extract from this race's pages (each race is ~5 pages)
    for page_num in range(page_start, min(page_start + 5, len(pdf.pages))):
...
def main():
    pdf_path = "data/2015 General Election Results.pdf"
    ...
    print("="*70)
    print("Extracting 2015 Kentucky Statewide Races")
    print("="*70)
    ...
    output_file = Path('data') / '20151103__ky__general__county.csv'
